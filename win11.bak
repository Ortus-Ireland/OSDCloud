...
function Show-Menu {
    ...
    Write-Host "2: Windows 11 Pro (All Drivers) [RIP]"
    Write-Host "3: Windows 10 Pro (Generic)"
    Write-Host "4: Surface Pro 9 [RIP]"
    Write-Host "5: Lenovo ThinkBook G8"
    Write-Host "6: Surface Go 4"
    Write-Host "7: Lenovo ThinkCentre M70s G3 [RIP]"
    Write-Host "8: Lenovo ThinkBook G7 [RIP]"
    ...
    Write-Host "16: Dell AIO QC24251"
    Write-Host "17: HP AIO BY6X0ET"
}
...
do
 {
    ...
    write-host 'Using Lenovo ThinkBook G8 image'
    $CustomImageFile = "http://wds/esd/Win11_LenovoThinkBookG8.esd"
    $selection = 'q'
    } '6' {
    ...
    write-host 'Using Surface Pro 10 image'
    $CustomImageFile = "http://wds/esd/Win11_SurfacePro10.esd"
    $selection = 'q'
    } '10' {
    ...
    write-host 'Using Dell Pro 16 PC16250 image'
    $CustomImageFile = "http://wds/esd/Win11_DellPro16250.esd"
    $selection = 'q'
    } '14' {
    ...
    write-host 'Using Dell AIO QC24251 image'
    $CustomImageFile = "http://wds/esd/Win11_Dell-AIO-QC24251.esd"
    $selection = 'q'
    } '17' {
    write-host 'Using HP AIO BY6X0ET image'
    $CustomImageFile = "http://wds/esd/Win11_HP-AIO-BY6X0ET.esd"
    $selection = 'q'
    }
    } 
 }
